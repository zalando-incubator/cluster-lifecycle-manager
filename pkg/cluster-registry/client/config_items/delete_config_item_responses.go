...
func (o *DeleteConfigItemReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /kubernetes-clusters/{cluster_id}/config-items/{config_key}] deleteConfigItem", response, response.Code())
	}
}
