...
func (o *UpdateInfrastructureAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /infrastructure-accounts/{account_id}] updateInfrastructureAccount", response, response.Code())
	}
}
