...
func NewUpdateNodePoolParams() *UpdateNodePoolParams {
	return NewUpdateNodePoolParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateNodePoolParams].
